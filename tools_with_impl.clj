{:tools [
 ...
 :implementations {
   :calculate_age {:fn "calculate-age" :file "ollama/tool_eval.clj"}
   :get_weather {:fn "get-weather" :file "ollama/tool_eval.clj"}
   :create_file {:fn "create-file" :file "ollama/tool_eval.clj"}
   :send_email {:fn "send-email" :file "ollama/tool_eval.clj"}
   :query_database {:fn "query-database" :file "ollama/tool_eval.clj"}
   :generate_code {:fn "generate-code" :file "ollama/tool_eval.clj"}
   :analyze_sentiment {:fn "analyze-sentiment" :file "ollama/tool_eval.clj"}
   :convert_currency {:fn "convert-currency" :file "ollama/tool_eval.clj"}}}